...
class Croisiere extends database{
    ...
    function addcroisiere($id_navire,$prix,$image,$nbr_nuit,$port_depart,$date_depart){
        $sql = "INSERT INTO `croisiere`(`id_navire`, `prix`, `image`, `nbr_nuit`, `port_depart`, `date_depart`) VALUES (:id_navire,:prix,:nbr_nuit,:image,:port_depart,:date_depart)";
